          ...
          <div class="container py-2">
            <div class="row">
              <div class="col-12 d-flex justify-content-between align-items-center text-center">
                <p class="fs-6 mb-1">{format!("© {} Developed with 💜 for ", get_current_year())}<a href="https://illuvium.io" target="_blank" class="text-decoration-none">{ "Illuvium" }</a>{" community and crypto enthusiasts"}</p>
